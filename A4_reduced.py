...
def createPars(box, n, isMasses=True, lin=True):
    ...
    Mn2 = np.linspace(box[0][1], box[-1][1], n[1], dtype=float) if lin else np.linspace(box[0][1], box[-1][1], n[1], dtype=float)
    Mch1 = np.linspace(box[0][2], box[-1][2], n[2], dtype=float) if lin else np.linspace(box[0][2], box[-1][2], n[2], dtype=float)
    Mch2 = np.linspace(box[0][3], box[-1][3], n[3], dtype=float) if lin else np.linspace(box[0][3], box[-1][3], n[3], dtype=float)
